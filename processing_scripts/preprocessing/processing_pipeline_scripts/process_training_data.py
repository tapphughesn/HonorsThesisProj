...
temp_dir = '/proj/NIRAL/users/nic98/DATA/training/temp_data_nrrd'
save_dir = '/proj/NIRAL/users/nic98/DATA/training/processed_data_nifti'
...
os.system("rm -rf /proj/NIRAL/users/nic98/DATA/training/temp_data_nrrd/*")
