...
loss_output_file = "/proj/NIRAL/users/nic98/models/unet_2.1/logfiles/loss_record_" + now + ".csv"
model_checkpoint_save_path = '/proj/NIRAL/users/nic98/models/unet_2.1/checkpoints/parameters_' + now

# Supply parent weights
parent_time = "09-27-2020-14:14:39"
model_checkpoint_load_path = "/proj/NIRAL/users/nic98/models/unet_2.1/checkpoints/parameters_" + parent_time
if (using_checkpoint):
...
weight_files = sorted(glob("/proj/NIRAL/users/nic98/DATA/training/train_on/weight_arrays/*"))
boundary_files = sorted(glob("/proj/NIRAL/users/nic98/DATA/training/train_on/boundary_arrays/*"))
...
record_file = open("/proj/NIRAL/users/nic98/models/unet_2.1/training_record.log", "a")
